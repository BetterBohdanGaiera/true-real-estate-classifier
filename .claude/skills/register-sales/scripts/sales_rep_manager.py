...
Note: This file was migrated from src/sales_agent/registry/sales_rep_manager.py

Usage:
    from sales_rep_manager import (
        create_sales_rep,
        get_by_telegram_id,
        list_all,
        list_active,
...
try:
    from .registry_models import SalesRepresentative, SalesRepStatus
except ImportError:
    from registry_models import SalesRepresentative, SalesRepStatus
