...
REGISTER_SCRIPTS = SKILLS_BASE / "register-sales/scripts"
...
from telegram_fetch import get_client, get_client_for_rep
...
from zoom_service import ZoomBookingService
...
class TelegramDaemon:
    ...
    async def initialize(self) -> None:
        ...
        if self.rep_telegram_id:
            ...
            sys.path.insert(0, str(REGISTER_SCRIPTS))
