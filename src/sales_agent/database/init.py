...
# Path to migrations directory (relative to this module)
...
async def check_database_connection() -> bool:
    ...
    Example:
        >>> import asyncio
        >>> from sales_agent.database.init import check_database_connection
...
async def run_migrations() -> int:
    ...
    Example:
        >>> import asyncio
        >>> from sales_agent.database.init import run_migrations
