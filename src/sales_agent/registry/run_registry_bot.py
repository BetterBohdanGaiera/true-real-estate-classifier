...
Usage:
    cd /Users/bohdanpytaichuk/Documents/TrueRealEstate/Classifier
...
async def main() -> None:
    ...
    from sales_agent.registry.registry_bot import RegistryBot
    ...
    try:
        from sales_agent.registry import sales_rep_manager, prospect_manager
        await sales_rep_manager.close_pool()
        await prospect_manager.close_pool()
