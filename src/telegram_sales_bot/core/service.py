...
from telegram_sales_bot.core.client import (
    get_client,
    resolve_entity,
    get_chat_type,
    format_message,
...
from telegram_sales_bot.core.models import AgentConfig, HumanPolishConfig
...
try:
    ...
    from telegram_sales_bot.humanizer.timing import NaturalTiming
